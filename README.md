...
* The report.pdf contains an overview of the project, advice for those seeking to embark on building something similar, and reflections
...
* [VHDL](https://nextjs.org/) - The VHSIC Hardware Description Language is a hardware description language that can model the behavior and structure of digital systems at multiple levels of abstraction, ranging from the system level down to that of logic gates, for design entry, documentation, and verification purposes
* [Xilinx Vivado](https://reactjs.org/) - Vivado Design Suite is a software suite produced by Xilinx for synthesis and analysis of HDL design
